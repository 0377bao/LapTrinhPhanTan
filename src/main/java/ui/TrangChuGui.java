...
public class TrangChuGui extends JPanel {
	public TrangChuGui() {
		...
		this.setLayout(null);
		JLabel lblBgr = new JLabel(new ImageIcon("src\\main\\java\\image\\imagepanel\\hinhnentrangchu.jpg"));
...
//		lấy hình gốc
		ImageIcon iconLblBgr = new ImageIcon("src\\main\\java\\image\\imagepanel\\hinhnentrangchu.jpg");
//		phóng to hình

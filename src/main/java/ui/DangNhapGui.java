...
public class DangNhapGui extends JFrame {
	...
	private TaiKhoanBus busTaiKhoan = new TaiKhoanBusImpl();
	private NhanVienBus busNhanVien = new NhanVienBusImpl();
	...
	public DangNhapGui() {
		...
		JLabel lblImageUser = new JLabel(
				new CustumImage().taoHinhTronAvt("src\\main\\java\\image\\imagepanel\\hinhnenuserdangnhap.png", 200));

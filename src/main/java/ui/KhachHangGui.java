...
public class KhachHangGui extends JPanel {
	...
	private KhachHangController ctrlKhachHang = new KhachHangController(this);
	...
	public KhachHangGui() throws RemoteException {
	...
	public void capNhatBangKhachHang(List<KhachHang> ds) {
		...
		for (KhachHang khachHang : ds) {
			modelKhachHang.addRow(new Object[] {
					...
					Tool.dinhDangTien(khachHang.getTongTienMua())
			});
		}
	}
	
	public void capNhatBangLichSuGD(List<HoaDon> ds) throws RemoteException {
	...
	public void xuLyKhiChonBangKhachHang() throws RemoteException {
		...
		txtTongTien.setText(Tool.dinhDangTien(kh.getTongTienMua()));
		capNhatBangLichSuGD(busHoaDon.layLichSuGiaoDichKhachHang(maKhachHang, 20));
	}
	
	public void xuLyXoaTrang() throws RemoteException {
	...
	public void xuLyTaoMaKhachHang() throws RemoteException {
		xuLyXoaTrang();
	...
	public void xuLySapXepTheoTongTien() throws RemoteException {
		if(chkSapXep.isSelected()) {
